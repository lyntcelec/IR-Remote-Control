...
class LgRemoteControl extends LitElement {
  ...
  render() {
    ...
    const textColor =
      this.config.colors && this.config.colors.texts
        ? this.config.colors.texts
        : "var(--primary-text-color)";
    ...
    return html`
      <div class="card">
        <div
          class="page"
          style="--remote-button-color: ${buttonColor}; --remote-text-color: ${textColor}; --remote-color: ${backgroundColor}; --remotewidth: ${remoteWidth};  --main-border-color: ${borderColor}; --main-border-width: ${borderWidth}"
        >
          ${this.config.name
            ? html` <span class="title"> ${this.config.name} </span> `
            : ""}
          <div
            class="grid-container-power"
            style="--remotewidth: ${remoteWidth}"
          >
            <button
              class="btn-flat flat-high ripple"
              @click=${() => this._channelList()}
            >
          ...
          ${this._show_inputs
                ...
                <div class="grid-container-input">
                  ...
                  <div class="grid-item-input">
                    ${stateObj.attributes.source_list.map(
                      (source) => html`
                        <button
                          class="${stateObj.attributes.source === source
                            ? "btn-input-on"
                            : "btn-input  ripple overlay"}"
                          @click=${() => {
            ...
            : html`
                 ${
                   this._show_sound_output
                     ? html`
                         ...
                         <div class="grid-container-sound">
                           ...
                           ${this._show_text
                             ? html`
                        <button class="btn_soundoutput ripple" @click=${() =>
                          (this._show_text = false)}>SOUND</button>
                          <button class="${
                            stateObj.attributes.sound_output === "tv_speaker"
                              ? "btn_sound_on tv bnt_sound_text_width"
                              : "btn_sound_off tv bnt_sound_text_width ripple overlay"
                          }"style="margin-left: calc(var(--remotewidth) / 10);" @click=${() =>
                          ...
                          <button class="${
                            ...
                            "tv_external_speaker"
                              ? "btn_sound_on tv-opt bnt_sound_text_width"
                              : "btn_sound_off tv-opt bnt_sound_text_width ripple overlay"
                          }" style="margin-right: calc(var(--remotewidth) / 10);" @click=${() =>
                                 this._select_sound_output(
                                   "tv_external_speaker"
                                 )}>TV + Optic</button>
                          <button class="${
                            ...
                            "tv_speaker_headphone"
                              ? "btn_sound_on tv-phone bnt_sound_text_width"
                              : "btn_sound_off tv-phone bnt_sound_text_width ripple overlay"
                          }" style="margin-left: calc(var(--remotewidth) / 10);" @click=${() =>
                                 this._select_sound_output(
                                   "tv_speaker_headphone"
                                 )}>TV + H-Phone</button>
                          <button class="${
                            stateObj.attributes.sound_output ===
                            "external_optical"
                              ? "btn_sound_on opt bnt_sound_text_width"
                              : "btn_sound_off opt bnt_sound_text_width ripple overlay"
                          }" style="margin-right: calc(var(--remotewidth) / 10);" @click=${() =>
                                 this._select_sound_output(
                                   "external_optical"
                                 )}>Optical</button>
                          <button class="${
                            stateObj.attributes.sound_output === "external_arc"
                              ? "btn_sound_on hdmi bnt_sound_text_width"
                              : "btn_sound_off hdmi bnt_sound_text_width ripple overlay"
                          }"style="margin-left: calc(var(--remotewidth) / 10);" @click=${() =>
                                 this._select_sound_output(
                                   "external_arc"
                                 )}>HDMI</button>
                          <button class="${
                            stateObj.attributes.sound_output === "lineout"
                              ? "btn_sound_on line bnt_sound_text_width"
                              : "btn_sound_off line bnt_sound_text_width ripple overlay"
                          }" style="margin-right: calc(var(--remotewidth) / 10);" @click=${() =>
                                 this._select_sound_output(
                                   "lineout"
                                 )}>Lineout</button>
                          <button class="${
                            stateObj.attributes.sound_output === "headphone"
                              ? "btn_sound_on phone bnt_sound_text_width"
                              : "btn_sound_off phone bnt_sound_text_width ripple overlay"
                          }" style="margin-left: calc(var(--remotewidth) / 10);" @click=${() =>
                                 this._select_sound_output(
                                   "headphone"
                                 )}>HeadPhone</button>
                          <button class="${
                            stateObj.attributes.sound_output === "bt_soundbar"
                              ? "btn_sound_on bluetooth bnt_sound_text_width"
                              : "btn_sound_off bluetooth bnt_sound_text_width ripple overlay"
                          }" style="margin-right: calc(var(--remotewidth) / 10);" @click=${() =>
                                 this._select_sound_output(
                                   "bt_soundbar"
                                 )}>Bluetooth</button>
                  ...
                  `
                             : html`
                      <button class="sound_icon_text  ripple" @click=${() =>
                        (this._show_text = true)}><ha-icon style="height: calc(var(--remotewidth) / 6); width: calc(var(--remotewidth) / 6);" icon="mdi:speaker"></button>
                        <button class="${
                          stateObj.attributes.sound_output === "tv_speaker"
                            ? "btn_sound_on tv bnt_sound_icon_width"
                            : "btn_sound_off tv bnt_sound_icon_width ripple overlay"
                        }" style="margin-left: calc(var(--remotewidth) / 7.5);" @click=${() =>
                                 this._select_sound_output(
                                   "tv_speaker"
                                 )}><ha-icon class="icon_source" icon="mdi:television-classic"></button>
                        <button class="${
                          stateObj.attributes.sound_output ===
                          "tv_external_speaker"
                            ? "btn_sound_on tv-opt bnt_sound_icon_width"
                            : "btn_sound_off tv-opt bnt_sound_icon_width ripple overlay"
                        ...
                        <button class="${
                          stateObj.attributes.sound_output ===
                          "tv_speaker_headphone"
                            ? "btn_sound_on tv-phone bnt_sound_icon_width"
                            : "btn_sound_off tv-phone bnt_sound_icon_width ripple overlay"
                        }" style="margin-left: calc(var(--remotewidth) / 7.5);" @click=${() =>
                                 this._select_sound_output(
                                   "tv_speaker_headphone"
                        ...
                        <button class="${
                          stateObj.attributes.sound_output ===
                          "external_optical"
                            ? "btn_sound_on opt bnt_sound_icon_width"
                            : "btn_sound_off opt bnt_sound_icon_width ripple overlay"
                        }" style="margin-right: calc(var(--remotewidth) / 7.5);" @click=${() =>
                                 this._select_sound_output(
                                   "external_optical"
                        ...
                        <button class="${
                          stateObj.attributes.sound_output === "lineout"
                            ? "btn_sound_on line bnt_sound_icon_width"
                        ...
                        <button class="${
                          stateObj.attributes.sound_output === "headphone"
                            ? "btn_sound_on phone bnt_sound_icon_width"
                            : "btn_sound_off phone bnt_sound_icon_width ripple overlay"
                        }" style="margin-left: calc(var(--remotewidth) / 7.5);" @click=${() =>
                                 this._select_sound_output(
                                   "headphone"
                                 )}><ha-icon class="icon_source" icon="mdi:headphones"></button>
                        <button class="${
                          stateObj.attributes.sound_output === "bt_soundbar"
                            ? "btn_sound_on bluetooth bnt_sound_icon_width"
                            : "btn_sound_off bluetooth bnt_sound_icon_width ripple overlay"
                        }" style="margin-right: calc(var(--remotewidth) / 7.5);" @click=${() =>
                                 this._select_sound_output(
                                   "bt_soundbar"
                                 )}><ha-icon class="icon_source" icon="mdi:bluetooth"></button>
                    </div>
                    `}
                           <!-- ################################# SOUND END ################################# -->
                         </div>
                         ...
                         ${this._show_keypad
                           ? html`
                               ...
                               <div class="grid-container-keypad">
                                 <button
                                   class="btn-keypad ripple"
                                   @click=${() => this._button("1")}
                                 >
                                   1
                                 </button>
                                 <button
                                   class="btn-keypad ripple"
                                   @click=${() => this._button("2")}
                                 >
                                   2
                                 </button>
                                 <button
                                   class="btn-keypad ripple"
                                   @click=${() => this._button("3")}
                                 >
                                   3
                                 </button>
                                 <button
                                   class="btn-keypad ripple"
                                   @click=${() => this._button("4")}
                                 >
                                   4
                                 </button>
                                 <button
                                   class="btn-keypad ripple"
                                   @click=${() => this._button("5")}
                                 >
                                   5
                                 </button>
                                 <button
                                   class="btn-keypad ripple"
                                   @click=${() => this._button("6")}
                                 >
                                   6
                                 </button>
                                 <button
                                   class="btn-keypad ripple"
                                   @click=${() => this._button("7")}
                                 >
                                   7
                                 </button>
                                 <button
                                   class="btn-keypad ripple"
                                   @click=${() => this._button("8")}
                                 >
                                   8
                                 </button>
                                 <button
                                   class="btn-keypad ripple"
                                   @click=${() => this._button("9")}
                                 >
                                   9
                                 </button>
                           ...
                           : html`
                               ...
                               <div class="grid-container-cursor">
                                 ...
                                 <button
                                   class="btn bnt_ok ripple item_2_c"
                                 ...
                                 <button
                                   ...
                                   style="background-color: transparent;"
                                   @click=${() => this._button("RIGHT")}
                                 >
                                   <ha-icon icon="mdi:chevron-right" />
                                 </button>
                                 <button
                                   class="btn ripple item_back"
                                   @click=${() => this._button("BACK")}
                                 >
                                   <ha-icon icon="mdi:undo-variant" />
                                 </button>
                                 <button
                                   ...
                                   style="background-color: transparent;"
                                   @click=${() => this._button("DOWN")}
                                 >
                                   <ha-icon icon="mdi:chevron-down" />
                                 </button>
                                 <button
                                   class="btn ripple item_exit"
                    ...
                    this.config.sources
                      ...
                      : html` <div class="grid-container-source">
                          ...
                          <button
                            class="btn_source ripple"
                            @click=${() =>
                              this._select_source("Amazon Prime Video")}
                          >
                            <ha-icon
                              style="heigth: 70%; width: 70%;"
                              icon="mdi:amazon"
...
<!-- ################################# COLORED BUTTONS END ################################# -->
                  ...
                  <div class="grid-container-volume-channel-control" >
                      ...
                      <button class="btn" style="border-radius: 0px; cursor: default; margin: 0px auto 0px auto; height: 100%;"><ha-icon icon="${
                        stateObj.attributes.is_volume_muted === true
                          ? "mdi:volume-off"
                          : "mdi:volume-high"
                      }"/></button>
                      <button class="btn ripple" Style="color:${
                        stateObj.attributes.is_volume_muted === true
                          ? "red"
                          : ""
                      }; height: 100%;"" @click=${() =>
                this._button("MUTE")}><span class="${
...
<!-- ################################# MEDIA CONTROL END ################################# -->
  ...
  _channelList() {
    const popupEvent = new Event("ll-custom", {
      bubbles: true,
      cancelable: false,
      composed: true,
    });
  ...
  _button(button) {
    ...
    if (this.config.remap[button] !== undefined) {
      command = this.config.remap[button].to;
    }
    console.log(this.config.remap[button]);
